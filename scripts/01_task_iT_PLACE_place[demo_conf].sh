...
CUDA_VISIBLE_DEVICES=$DEVICE python iTClearance_PLACE/examples/comparisson/testing/03_test_place_AUTO_selected_points[demo_conf].py  --base_dir /home/alexa/Abel/DATA/PLACE_trainings
