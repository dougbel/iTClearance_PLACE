...
CUDA_VISIBLE_DEVICES=$DEVICE python iTClearance_PLACE/examples/comparisson/testing_PLACE_then_iTC/02_itC_optimizer_SMPLX_body_parameters[demo_conf].py --base_dir /home/alexa/Abel/DATA/PLACE_trainings
