...
if __name__ == '__main__':
    ...
    # python iTClearance_PLACE/examples/comparisson/testing/03_test_place_AUTO_selected_points[demo_conf].py  --base_dir /media/dougbel/Tezcatlipoca/PLACE_trainings
    ...
    output_dir = opj(base_dir, 'test', 'sampled_place_exec[demo_conf]')

    follow_up_file = opj(base_dir,'test', 'follow_up_process.csv')
    current_follow_up_column = "place_auto_samples_extracted[demo_conf]"
