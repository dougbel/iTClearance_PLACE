...
if __name__ == '__main__':
    ...
    if not os.path.exists(amt_follow_up_real_file):
        ...
        l_unary_fake = get_full_evaluation_fake_samples_list(general_follow_up_data, fake_gifs_dir, real_gifs_dir)
    ...
    samples_used_file = opj(output_dir, 'full_list_samples_used.csv')
