...
if __name__ == '__main__':
    ...
    loss_non_collisions_dataset_opt1 = []
    loss_contacts_dataset_opt1 = []
    loss_collision_n_points_dataset_opt1 = []
    loss_collision_sum_depths_dataset_opt1 = []

    loss_non_collisions_dataset_opt2 = []
    loss_contacts_dataset_opt2 = []
    loss_collision_n_points_dataset_opt2 = []
    loss_collision_sum_depths_dataset_opt2 = []
    ...
    for file in os.listdir(studies_dir):
        ...
        loss_non_collision_env_opt1, loss_contact_env_opt1 = [], []
        loss_collision_n_points_opt1, loss_collision_sum_depths_opt1 = [], []
        loss_non_collision_env_opt2, loss_contact_env_opt2 = [], []
        loss_collision_n_points_opt2, loss_collision_sum_depths_opt2 = [], []
        ...
        for idx, row in conglo_data.iterrows():
            ...
            current_loss_non_coll_opt1 = conglo_data.loc[idx, [follow_up_column + "_non_collision_optim"]].values[0]
            current_loss_contact_opt1 = conglo_data.loc[idx, [follow_up_column + "_contact_sample_optim"]].values[0]
            current_contact_n_points_opt1 = conglo_data.loc[idx, [follow_up_column + "_collision_points_optim"]].values[0]
            current_contact_sum_depths_opt1 = conglo_data.loc[idx, [follow_up_column + "_collision_sum_depths_optim"]].values[0]

            loss_non_collision_env_opt1.append(current_loss_non_coll_opt1)
            loss_contact_env_opt1.append(current_loss_contact_opt1)
            loss_collision_n_points_opt1.append(current_contact_n_points_opt1)
            loss_collision_sum_depths_opt1.append(current_contact_sum_depths_opt1)

            loss_non_collisions_dataset_opt1.append(current_loss_non_coll_opt1)
            loss_contacts_dataset_opt1.append(current_loss_contact_opt1)
            loss_collision_n_points_dataset_opt1.append(current_contact_n_points_opt1)
            loss_collision_sum_depths_dataset_opt1.append(current_contact_sum_depths_opt1)

            current_loss_non_coll_opt2 = conglo_data.loc[idx, [follow_up_column + "_non_collision_adv_optim"]].values[0]
            current_loss_contact_opt2 = conglo_data.loc[idx, [follow_up_column + "_contact_sample_adv_optim"]].values[0]
            current_contact_n_points_opt2 = conglo_data.loc[idx, [follow_up_column + "_collision_points_adv_optim"]].values[0]
            current_contact_sum_depths_opt2 = conglo_data.loc[idx, [follow_up_column + "_collision_sum_depths_adv_optim"]].values[0]

            loss_non_collision_env_opt2.append(current_loss_non_coll_opt2)
            loss_contact_env_opt2.append(current_loss_contact_opt2)
            loss_collision_n_points_opt2.append(current_contact_n_points_opt2)
            loss_collision_sum_depths_opt2.append(current_contact_sum_depths_opt2)

            loss_non_collisions_dataset_opt2.append(current_loss_non_coll_opt2)
            loss_contacts_dataset_opt2.append(current_loss_contact_opt2)
            loss_collision_n_points_dataset_opt2.append(current_contact_n_points_opt2)
            loss_collision_sum_depths_dataset_opt2.append(current_contact_sum_depths_opt2)
    ...
    logging.info('\n ---------------------------------------------------------------------------------------------')
    logging.info('\n OPTIMIZED OUTPUT')
    logging.info('\n'+tabulate(tb_data_opt1,headers=tb_headers_opt1, floatfmt=".4f",  tablefmt="latex_booktabs"))
    logging.info('\n'+tabulate(tb_data_opt1,headers=tb_headers_opt1, floatfmt=".4f",  tablefmt="simple"))

    logging.info('\n\n\n')
    logging.info('\n ---------------------------------------------------------------------------------------------')
    logging.info('\n ---------------------------------------------------------------------------------------------')
    logging.info('\n ADVANCE OPTIMIZED OUTPUT')
    logging.info('\n' + tabulate(tb_data_opt2, headers=tb_headers_opt2, floatfmt=".4f", tablefmt="latex_booktabs"))
    logging.info('\n' + tabulate(tb_data_opt2, headers=tb_headers_opt2, floatfmt=".4f", tablefmt="simple"))
