...
CUDA_VISIBLE_DEVICES=$DEVICE python /home/alexa/Abel/projects/04_place_execution/iTClearance_PLACE/examples/comparisson/testing/ablation_study/03_measure_scores_per_interaction_type_ICP_1_calculation.py
