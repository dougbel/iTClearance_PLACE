...
if __name__ == "__main__":
    ...
    # mpiexec -n 2 python examples/comparisson/testing/01_testing.py --dataset_scans_path /media/dougbel/Tezcatlipoca/PLACE_trainings/datasets --work_directory /media/dougbel/Tezcatlipoca/PLACE_trainings/test  --config_directory /media/dougbel/Tezcatlipoca/PLACE_trainings/config
    import pydevd_pycharm
    port_mapping = [33835, 43267]
    ...
    if rank == 0:  # Master
        ...
        app = MasterRoutines(slaves=range(1, size), work_directory=opt.work_directory, follow_up_column="env_tested")
        app.run()
