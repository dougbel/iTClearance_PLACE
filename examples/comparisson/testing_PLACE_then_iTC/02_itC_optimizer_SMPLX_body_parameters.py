...
if __name__ == '__main__':
    ...
    it_results_dir = opj(base_dir, 'test_place_picker', 'env_test')
    samples_dir = opj(base_dir, 'test_place_picker', 'sampled_it_clearance')
    output_dir = opj(base_dir, 'test_place_picker', 'sampled_it_clearance_opti_smplx')
