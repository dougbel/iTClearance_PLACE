...
# trained model path
scene_bps_AE_path =  f'{data_dir}/pretained/aes/sceneBpsAE_last_model.pkl'
cVAE_path = f'{data_dir}/pretained/aes/cVAE_last_model.pkl'
scene_verts_AE_path = f'{data_dir}/pretained/aes/sceneBpsVertsAE_last_model.pkl'
bodyDec_path = f'{data_dir}/pretained/aes/body_dec_last_model.pkl'
